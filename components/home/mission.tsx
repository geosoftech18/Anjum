      ...
      <div className="container py-20">
        <div className="space-y-12">
          <div className="space-y-3">
            ...
            <Heading className="text-secondary-2 dark:text-secondary-2 sm:text-4xl">
          ...
          <TabGroup defaultIndex={0}>
            <TabList className="flex justify-start flex-wrap gap-2 mb-8 border-0">
              <Tab
                className="bg-secondary-2 text-tertiary rounded-full py-2.5 px-6 hover:bg-secondary hover:text-white"
                activeClassName="bg-secondary text-white dark:text-white"
                inactiveClassName="bg-secondary-2 text-tertiary hover:bg-secondary"
              >
                Private Labelling
              </Tab>
              <Tab
                className="bg-secondary-2 text-tertiary rounded-full py-2.5 px-6 hover:bg-secondary hover:text-white"
                activeClassName="bg-gold text-white dark:text-white"
                inactiveClassName="bg-secondary-2 text-tertiary hover:bg-secondary"
              >
                Custom Formulations
              </Tab>
            ...
            <TabPanels>
              <TabPanel className="flex flex-col md:flex-row gap-16 items-center">
                ...
                <div className="md:w-1/2 space-y-6">
                  ...
                  <Button
                    color="green"
                    className="sm:text-lg sm:!py-2 sm:!px-9"
                  >
                    Know more
                  </Button>
                </div>
              ...
              <TabPanel className="flex flex-col md:flex-row gap-16 items-start">
                ...
                <div className="md:w-1/2 space-y-4">
                  <Heading level={3} className="text-secondary-2 text-2xl">
                    Custom Formulations
                  </Heading>
                  <Text>
                  ...
                  <div className="pt-4">
                    <a
                      href="#"
                      className="inline-flex items-center justify-center px-6 py-3 bg-secondary-2 text-tertiary rounded-full hover:bg-secondary transition-colors"
                    >
                      Know more
                    </a>
                  </div>
