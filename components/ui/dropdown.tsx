  ...
  return (
    <Headless.MenuItems
      ...
      className={clsx(
        ...
        'overflow-y-auto',
        // Popover background
        'bg-white/75 backdrop-blur-xl dark:bg-white/75',
        // Shadows
...
export function DropdownItem({
  ...
  const classes = clsx(
    ...
    // Text styles
    'text-left text-base/6 text-secondary-600 sm:text-sm/6 dark:text-secondary-600 forced-colors:text-[CanvasText]',
    // Focus
    'data-[focus]:bg-secondary-600 data-[focus]:text-white',
    // Disabled state
